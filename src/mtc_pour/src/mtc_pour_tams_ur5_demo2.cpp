...
#include <moveit/task_constructor/stages/pour_into2.h>              //from mtc_pour/include/moveit/...              //<=============== new
#include "mtc_pour/demo_utils2.hpp"                               ////from mtc_pour/include/mtc_pour/...          //<=============== new
...
int main(int argc, char** argv){
	...
	upright_constraint.orientation_constraints.resize(1);
	{
		...
		c.link_name= "s_model_tool0";   //constraining tool frame
		c.header.frame_id= "table_top"; //reference frame
		c.orientation.w= 1.0;
	...
	Task t("my_task");
	t.loadRobotModel(); //loadRobotModel
    ...
    // ======================= grasp workspace pose -> grasp pose ====================================//
	{
    ...
    // ======================= place pose -> place pose kinematics====================================//
	{
    ...
    // printf("************* t.numSolutions() = %d, execute=%d *************\n",t.numSolutions(),execute);
