...
//**********************************************************************************************************************************************//
	...
	// Set task properties
	// t.setProperty("group", "panda2_arm");
	// t.setProperty("eef", hand2_eef);
	// t.setProperty("hand", hand2);
	// t.setProperty("hand_grasping_frame", panda2_link8);
	// t.setProperty("ik_frame", panda2_link8);
