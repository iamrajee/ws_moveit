#include <moveit_task_constructor_demo/pick_place_task9.h>
...
//**********************************************************************************************************************************************//
    ...
    // ====================== Place Object ====================== //
	{
        ...
        // ---------------------- Generate Place Pose ---------------------- //
		{
			...
			p.header.frame_id = object_reference_frame_;
			p.pose = place_pose2_;
			p.pose.position.z += (1.5 * object_dimensions_[0] + 2*place_surface_offset_); //placing com at half height of same object2 so that bottom surface touch ground
			// p.pose.position.z += 0.5 * object_dimensions_[0] - place_surface_offset_;
			stage->setPose(p);
			stage->setMonitoredStage(attach_object_stage);  // Hook into attach_object_stage
			// Compute IK
